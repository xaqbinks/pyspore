...
class DietSelectionMenu(BaseState):
    def __init__(self):
        super().__init__()
        ...
        self.prompt_text = self.prompt_font.render("Choose Your Diet", True, WHITE)
        self.prompt_rect = self.prompt_text.get_rect(center=(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 4))
    ...
    def draw(self, surface):
        ...
        herb_text = self.button_font.render("Herbivore", True, WHITE)
        ...
        carn_text = self.button_font.render("Carnivore", True, WHITE)
